...
`demo_video_script.md`, covering: the problem, the dataset, the notebook walkthrough,
key results, and a live scoring demo of a normal vs. a fraudulent transaction.

---
*Capstone project — Mobile Money Fraud Detector — Intermediate difficulty.*
